...
1. Die Adresse in Chrome auf dem Handy öffnen oder den QR-Code unter „Auf dem Android-Handy installieren“ scannen.
2. „App installieren“ wählen. Falls kein Button erscheint: Chrome-Menü ⋮ → „Zum Startbildschirm hinzufügen“ → „Installieren“. Bei manchen Chrome-Versionen heißt der Menüpunkt „Installieren und Verknüpfung erstellen“.
...
Unter „Sicherung und Gerätewechsel“ eine JSON-Sicherung mit allen Projekten einschließlich Fotos herunterladen. Diese Datei kann auf einem anderen Gerät über „Sicherung einlesen“ übernommen werden. Bereits vorhandene Projektnummern werden übersprungen, nicht ersetzt. Eine Sicherung kann nach versehentlichem Löschen erneut eingelesen werden. Nicht gespeicherte Konfliktstände werden im Export zusätzlich als eindeutig benannte Kopie gesichert.
...
- `app.js`: mobile Bedienung, automatisches Speichern, Sicherung/Import, komprimierte Fotos und Installation.
